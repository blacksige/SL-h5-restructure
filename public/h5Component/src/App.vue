<template>
  <div id="app">
    ...
    <queue v-if="Step === 'queue'" @updatedStep = "updatedStep" @onVideoStart = "onVideoStart"  @onError = "onError"></queue>
    <call v-else-if="Step === 'call'"  @onVideoEnd = "onVideoEnd"  @onError = "onError"></call>
